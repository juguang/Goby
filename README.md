...
| | |
| --- | --- |
| **Tools for the live web** | 22 built-in tools — query, list, fill, click, check, select, submit, wait, evaluate, screenshot, analyze, navigate, open_tab, list_tabs, close_tab, finish_workflow, search bookmarks, and more. The page is the agent's workspace. |
